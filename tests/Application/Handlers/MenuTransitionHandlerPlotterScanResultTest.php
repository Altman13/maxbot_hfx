...
class MenuTransitionHandlerPlotterScanResultTest extends TestCase
{
    ...
    public function testHandlePlotterScanResult(): void
    {
        ...
        $result = $this->invokePrivate('handlePlotterScanResult', [
            'какой-то текст',
            '123',
            State::Scan_Plotter_QR_Code->value,
        ]);

        $this->assertTrue($result);
    }

    public function testHandlePlotterScanResultReturnsFalseForUnlockCutter(): void
    {
        $result = $this->invokePrivate('handlePlotterScanResult', [
    ...
    public function testHandlePlotterScanResultReturnsFalseForOtherState(): void
    {
        $result = $this->invokePrivate('handlePlotterScanResult', [
            'какой-то текст',
            '123',
