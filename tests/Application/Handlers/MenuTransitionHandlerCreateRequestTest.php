...
class MenuTransitionHandlerCreateRequestTest extends TestCase
{
    ...
    public function testHandleCreateRequestWithoutIssueInitiatesNewRequest(): void
    {
        ...
        $result = $this->invokePrivate('handleCreateRequest', [
    ...
    public function testHandleCreateRequestWithIssueShowsWarning(): void
    {
        ...
        $this->stateFileHandler->shouldReceive('setStateField')
            ->with('123', 'state', State::Issue_AlReady_Exist->value)
            ->once();

        $menu = ['chat_id' => '123', 'text' => 'Warning'];
        $this->menuCreateAction->shouldReceive('createMenuLogicWithKeyboardType')
            ->once()
            ->andReturn($menu);
    ...
    public function testHandleCreateRequestReturnsFalseForOtherState(): void
    {
        $result = $this->invokePrivate('handleCreateRequest', [
            State::Create_Request->value,
            '123',
    ...
    public function testHandleCreateRequestReturnsFalseForOtherText(): void
    {
        $result = $this->invokePrivate('handleCreateRequest', [
            'какой-то текст',
            '123',
